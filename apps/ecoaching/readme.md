...
* `firebase.ecoaching.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp ecoaching` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run ecoaching:deploy` - Deploy this app to firebase
* `nx run ecoaching:serve` - Serve this app using the firebase emulator
* `nx run ecoaching:build` - Build all functions associated with this app
* `nx run ecoaching:test` - Test all functions associated with this app
* `nx run ecoaching:lint` - Lint all functions associated with this app
